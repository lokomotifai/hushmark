...
maintainer at `fatih@komunite.com.tr`. Reports will be reviewed promptly and fairly. The maintainer
will respect the privacy and security of the reporter and affected people. If a report concerns the
maintainer, the reporter may ask a trusted neutral open-source community leader to help document and
mediate the matter until an independent reviewer can be identified.
...
available under the [Creative Commons Attribution 4.0 License](https://creativecommons.org/licenses/by/4.0/).

...
| Tampering              | Policy, audit, image, or license modification         | Strict schemas, SHA-256/JCS audit chain, ed25519 license, digest pins, Cosign/SBOM workflow                       | Production signing ceremony and external anchor custody wait for authorization                    |

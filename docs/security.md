...
| Tampering              | Policy, audit, image, or license modification         | Strict schemas, HMAC-SHA-256/JCS audit chain, append-only external head checkpoints, runtime model digest verification, ed25519 license, digest pins, keyless Cosign signatures and SBOM attestations | Checkpoint storage custody and customer verification policy remain deployment responsibilities    |
